            ...
            bannersData.data.banner_items.map((item, i) => (
              <SwiperSlide key={i} className="relative">
                ...
                <div
                  ...
                  <div
                    className={clsx(
                      'flex flex-col sm:pr-0 pr-10 justify-center gap-2 z-50 absolute top-10 left-0 mx-auto',
                      {
                        'max-w-[650px]': activeLang.localization === 'ru',
                        'max-w-[550px]': activeLang.localization === 'en',
                      },
                    )}>
                    {/* <svg
                      width="143"
                    ...
                    {/* <h2 className="md:text-[56px] sm:text-[40px] text-[36px] leading-[120%] font-medium">
                      {useLang(
