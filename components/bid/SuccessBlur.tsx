...
export const SuccessBlur = ({ setSuccess }: { setSuccess: (bol: boolean) => void }) => {
  return (
    <div className="fixed top-0 right-0 bottom-0 left-0 z-[3000] backdrop-blur-sm w-full h-screen bg-darkBlue/50">
