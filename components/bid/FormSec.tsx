    ...
    <form className="w-full max-w-[538px] tab:mx-0 mx-auto" onSubmit={handleSubmit(onSubmit)}>
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          <input {...register('phone')} name="phone" id="phone" type="text" className="bid-input" />
        ...
        <div className="flex flex-col gap-4">
          ...
          <input {...register('email')} name="email" id="email" type="text" className="bid-input" />
      ...
      <div className="flex flex-col gap-4">
        ...
        <button className="w-full py-[17px] bg-green text-white">Отправить</button>
      </div>
    </form>
  );
};
