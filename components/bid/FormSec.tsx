    ...
    <>
      ...
      >
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-4">
            <label htmlFor="company_name" className="form-label">
              {useLang("Company name", "Название компании:")}
          ...
          <label htmlFor="contact_person" className="form-label">
            {useLang("Contact person (full name)", "Контактное лицо (Ф.И.О.):")}
            <span className="text-lightRed">*</span>
          </label>
          <input
          ...
          <div className="flex flex-col gap-4">
            <label
              ...
              className="form-label leading-[150%]"
            >
              {useLang(
        ...
        <div className="flex flex-col gap-6 mt-10">
          ...
          >
            {isLoading
              ? useLang("Sending", "Идет отправка")
              : useLang("Send", "Отправить")}
          </button>
        </div>
      </form>
    </>
