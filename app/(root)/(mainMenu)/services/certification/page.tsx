...
const page = () => {
  ...
  return (
    <LayoutWithSidebar
      title={servicesData?.data ? servicesData.data[3].title : ''}
      second={useLang('Services', 'Услуги')}
      third={servicesData?.data ? servicesData.data[3].title : ''}>
      <div
        className="select-inner"
        dangerouslySetInnerHTML={{ __html: servicesData ? servicesData.data[3].content : '' }}
      />
    </LayoutWithSidebar>
  );
};
