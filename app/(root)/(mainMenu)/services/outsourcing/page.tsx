...
const page = () => {
  ...
  return (
    <LayoutWithSidebar
      title={servicesData?.data ? servicesData.data[5].title : ''}
      second={useLang('Services', 'Услуги')}
      third={servicesData?.data ? servicesData.data[5].title : ''}>
      <div
        className="select-inner"
        dangerouslySetInnerHTML={{ __html: servicesData ? servicesData.data[5].content : '' }}
      />
    </LayoutWithSidebar>
  );
};
